    ...
    <div ref={containerRef} className="relative w-full max-w-sm">
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-white/10 bg-white/5 py-2.5 pl-9 pr-4 text-sm text-white placeholder-zinc-500 outline-none focus:border-purple-600 focus:ring-1 focus:ring-purple-600 transition [data-theme=light]:bg-white [data-theme=light]:text-[#0a0a14] [data-theme=light]:border-black/10"
        />
        {query && (
          <button
