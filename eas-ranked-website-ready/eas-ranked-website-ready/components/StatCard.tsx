...
> = {
  ...
  blue: {
    ...
    accent:       "rgba(77,238,234,0.8)",
    iconBg:       "rgba(77,238,234,0.12)",
  ...
  teal: {
    ...
    accent:       "rgba(168,255,246,0.8)",
    iconBg:       "rgba(168,255,246,0.10)",
    border:       "rgba(168,255,246,0.20)",
    gradientFrom: "#A8FFF6",
    gradientTo:   "#4DEEEA",
  },
  coral: {
...
export default function StatCard({
  ...
  return (
    <div
      className={`stat-card-ocean group animate-card-entrance gpu-accelerate ${className}`}
      style={{
      ...
      <div className="relative flex items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-2 flex items-center gap-2 flex-wrap">
            {note && (
              <p className="text-[10px] transition-colors duration-200" style={{ color: "rgba(168,255,246,0.50)" }}>{note}</p>
            )}
            {trend !== undefined && (
              <span
                ...
                style={trend > 0
                  ...
                  : { background: "rgba(168,255,246,0.06)", color: "rgba(168,255,246,0.45)", border: "1px solid rgba(168,255,246,0.12)" }
                }
              >
                {trend > 0 ? "↑" : trend < 0 ? "↓" : "—"}
