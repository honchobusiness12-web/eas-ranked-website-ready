  ...
  return (
    <Shell>
      ...
      <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-black tracking-tight" style={{ color: "#e2f4ff" }}>🏷️ Rank System</h1>
          <p className="mt-0.5 text-sm" style={{ color: "rgba(168,255,246,0.55)" }}>
        ...
        <SoundLink
          ...
          style={{ border: "1px solid rgba(255,127,80,0.35)", background: "rgba(255,127,80,0.10)", color: "#FF7F50" }}
        >
          📖 How Ranked Works →
        </SoundLink>
      </div>
      ...
      <div className="space-y-4">
        {tierOrder.map((tier) => {
          ...
          return (
            <div key={tier} className="rounded-2xl p-5 animate-card-entrance" style={{ border: "1px solid rgba(0,207,255,0.18)", background: "rgba(6,43,69,0.72)", backdropFilter: "blur(16px)" }}>
              {/* Tier header */}
              <div className="flex flex-wrap items-start justify-between gap-3 mb-4">
                ...
                <div className="shrink-0 rounded-lg px-3 py-2 text-center" style={{ border: "1px solid rgba(0,207,255,0.2)", background: "rgba(0,207,255,0.07)" }}>
                  <p className="text-[10px] uppercase tracking-wider" style={{ color: "rgba(168,255,246,0.5)" }}>CR Range</p>
                ...
                {tierRanks.map((rank) => {
                  ...
                  return (
                    <div
                      ...
                      style={{ border: "1px solid rgba(0,207,255,0.15)", background: "rgba(0,207,255,0.05)" }}
                    >
                      ...
                      <p className="mt-1 text-base font-black" style={{ color: "#e2f4ff" }}>{rank.min.toLocaleString()} CR</p>
                    </div>
                  );
                })}
              </div>
              ...
              <div className="flex items-start gap-2 rounded-lg px-3 py-2.5" style={{ border: "1px solid rgba(0,207,255,0.15)", background: "rgba(0,207,255,0.06)" }}>
                ...
                <p className="text-xs" style={{ color: "rgba(168,255,246,0.6)" }}>{meta.tip}</p>
              </div>
            </div>
          );
        })}
