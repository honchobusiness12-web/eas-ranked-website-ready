...
CREATE TABLE IF NOT EXISTS admin_audit_logs (
  ...
  action         VARCHAR(64) NOT NULL,             -- e.g. 'assign_badge', 'remove_badge', 'grant_premium'
  target_user_id VARCHAR(32) NOT NULL,             -- Discord user ID of the affected player
  details        JSONB       NOT NULL DEFAULT '{}',-- Action-specific metadata (badge id, stats, etc.)
